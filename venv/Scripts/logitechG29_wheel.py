...
class Controller:
    ...
    def __init__(self, id, dead_zone = 0):
        """
        ...
        self._steer_idx     = int(self._parser.get('G29 Racing Wheel', 'steering_wheel')) # right
        self._clutch_idx  = int(self._parser.get('G29 Racing Wheel', 'gear')) # currently brake
        self._throttle_idx = int(self._parser.get('G29 Racing Wheel', 'throttle')) # currently clutch
        self._brake_idx     = int(self._parser.get('G29 Racing Wheel', 'brake')) # currently throttle
